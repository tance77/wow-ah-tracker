    ...
    <form wire:submit="login">
        ...
        <div class="block mt-4">
            <label for="remember" class="inline-flex items-center">
                <input wire:model="form.remember" id="remember" type="checkbox" class="rounded bg-wow-darker border-gray-600 text-wow-gold shadow-sm focus:ring-wow-gold focus:ring-offset-wow-darker" name="remember">
